...
exports.sendPlainListTemplate = function(recepientId){
  var messageData = {
  "recipient":{
    "id":recepientId
  },
            ...
            "elements": [
                {
                    ...
                    "default_action": {
                        "type": "web_url",
                        "url": "https://83.212.112.6/",
                        "messenger_extensions": true,
                        "webview_height_ratio": "tall",
                        "fallback_url": "https://83.212.112.6/"
                    },
                    "buttons": [
                        {
                            "title": "Buy",
...
exports.sendReadReceipt = function(recipientId) {
 ...
 exports.sendSelectPrintPropertiesMessage = function(recipientId) {
   /*var souvlakiData1 = {
     recipient: {
     },
     message: {
       ...
       id: recipientId
         ...
         payload: {
           template_type: "generic",
           elements: [{
             title: "Σουβλάκια ο Λευτέρης",
             image_url: "https://snf-744441.vm.okeanos.grnet.gr/pictures/soublaki2.jpeg",
             subtitle: " Τα καλύτερα σουβλάκια της Καλλιθέας",
             buttons: [{
               type: "web_url",
               url: "https://snf-744441.vm.okeanos.grnet.gr/mywebview",
               title: "Mενού",
               "webview_height_ratio": "full"
             }, {
               type: "postback",
               title: "Προηγούμενη Επιλογή",
               payload: "Payload for first bubble",
             }],
           }]
         }
 ...
 */
 var printMessageData = {
       ...
       message: {
         attachment: {
           ...
           payload: {
             ...
             elements: [{
               title: "Καλώς ήρθες",
               subtitle: "Φαίνεται ότι έρχεσαι για πρώτη φορά εδώ.",
               buttons: [{
                 type: "web_url",
                 url: "https://snf-744441.vm.okeanos.grnet.gr/mywebview",
                 title: "Εγγραφή",
         ...
         attachment: {
           ...
           payload: {
             ...
             elements: [{
               ...
               buttons: [{
                 type: "account_link",
                 url: "https://snf-744441.vm.okeanos.grnet.gr/authorize",
               }],
             }]
           }
         }
   ...
   callSendAPI(regPrint);
   //chatconv.foo(); never worked.
 }
